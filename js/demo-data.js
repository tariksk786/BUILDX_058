...
// ============================================
const facilities = [
  { id: 'HOSP-A', name: 'City Trauma Care (Hospital A)', type: 'Hospital', city: 'Mumbai', latitude: 19.0790, longitude: 72.8820, operationalStatus: 'Active', distance: 1.8, driveTimeMinutes: 5, reportedIcuCapacity: 10, availableIcu: 0, hasTraumaTeam: true, bloodBankOnSite: false, lastDataUpdateMinutesAgo: 3, freshnessState: 'FRESH' },
  { id: 'HOSP-B', name: 'Apex Medical Center (Hospital B)', type: 'Hospital', city: 'Mumbai', latitude: 19.0850, longitude: 72.8940, operationalStatus: 'Active', distance: 2.9, driveTimeMinutes: 7, reportedIcuCapacity: 8, availableIcu: 2, hasTraumaTeam: true, bloodBankOnSite: true, lastDataUpdateMinutesAgo: 48, freshnessState: 'STALE' },
  { id: 'HOSP-C', name: 'Metro General Hospital (Hospital C)', type: 'Hospital', city: 'Mumbai', latitude: 19.0950, longitude: 72.9100, operationalStatus: 'Active', distance: 4.2, driveTimeMinutes: 9, reportedIcuCapacity: 6, availableIcu: 1, hasTraumaTeam: true, bloodBankOnSite: true, lastDataUpdateMinutesAgo: 2, freshnessState: 'FRESH' },
...
const demoUsers = [
  // TRUST CARE Primary Operational Roles
  { id: 'u-dispatcher', email: 'dispatcher@trustcare.org', displayName: 'Aarav Mehta', role: 'dispatcher', department: 'Central Emergency Dispatch', organization: 'Central EMS Control', phone: '+91 9876543201', isDemo: true },
  { id: 'u-hosp-desk', email: 'emergency.desk@metrogeneral.org', displayName: 'Metro Emergency Desk Coordinator', role: 'hospital_desk', department: 'Emergency Receiving Desk', organization: 'Metro General Hospital', phone: '+91 9876543202', isDemo: true },
  { id: 'u-blood-desk', email: 'blood.desk@metrogeneral.org', displayName: 'Metro Blood Bank Lead', role: 'blood_bank', department: 'Blood Transfusion Service', organization: 'Metro General Blood Bank', phone: '+91 9876543203', isDemo: true },
  { id: 'u-admin', email: 'admin@trustcare.org', displayName: 'TRUST CARE Operations Director', role: 'admin', department: 'System Administration & Governance', organization: 'State Emergency Authority', phone: '+91 9876543210', isDemo: true },
  { id: 'u-public', email: 'caller@emergency.org', displayName: 'Public Caller (Citizen)', role: 'public', department: 'Emergency Requester', phone: '+91 9811223344', isDemo: true },

  // HospitalFlow Legacy Roles (Preserved)
  { id: 'u-admin-legacy', email: 'admin@hospitalflow.ai', displayName: 'Admin User', role: 'admin', department: null, phone: '+91 9876543210' },
...
export function generateDemoState() {
  return {
    ...
    emergencyCases,
    emergencyAlerts,
    // TRUST CARE Core Collections
    trustcareCases: [],
    hospitalResources: [
      { id: 'HOSP-A-ICU-01', hospitalId: 'HOSP-A', resourceType: 'ICU', resourceCode: 'ICU-Bed-01', status: 'OCCUPIED', lastStatusUpdate: new Date(Date.now() - 3 * 60000).toISOString(), freshnessState: 'FRESH' },
