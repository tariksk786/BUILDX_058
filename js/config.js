...
const Config = {
  ...
  APP_NAME: 'TRUST CARE',
  APP_TAGLINE: 'Right Hospital. Confirmed Resources. Ready Before Arrival.',
  VERSION: '2.0.0',
  ...
  // Roles (Primary TRUST CARE Roles + Optional Public & Doctor)
  ROLES: {
    DISPATCHER: 'dispatcher',
    HOSPITAL_DESK: 'hospital_desk',
  ...
  ROLE_LABELS: {
    dispatcher: 'Ambulance Dispatcher',
    hospital_desk: 'Hospital Emergency Desk',
    blood_bank: 'Blood Bank Desk',
    admin: 'Trust Care Operations Director',
    public: 'Emergency Requester (Public)',
    doctor: 'Receiving Physician / Trauma Lead',
    reception: 'Reception',
    patient: 'Patient'
  },
